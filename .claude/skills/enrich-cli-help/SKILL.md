...
- Seqera Platform CLI repository: `/Users/llewelyn-van-der-berg/Documents/GitHub/tower-cli`
- Working directory should be: `/Users/llewelyn-van-der-berg/Documents/GitHub/tower-cli/docs/scripts`
- Git branch: `ll-metadata-extractor-and-docs-automation` (or appropriate feature branch)
...
1. **Review changes**:
   ```bash
   cd /Users/llewelyn-van-der-berg/Documents/GitHub/tower-cli
   git diff --stat
...
1. **Update progress.md**: Document new phase with statistics
2. **Extract metadata**: Run `python docs/scripts/extract-cli-metadata.py` to update JSON
...
```bash
# Working directory
cd /Users/llewelyn-van-der-berg/Documents/GitHub/tower-cli/docs/scripts
...
python extract-cli-metadata.py ../../src/main/java > ../cli-metadata.json
```

## References

- **Progress tracker**: `docs/scripts/progress.md`
- **CLI metadata**: `docs/cli-metadata.json`
