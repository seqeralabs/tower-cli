...
public class DatasetsCmdTest extends BaseCmdTest {
    ...
    void testCreate(OutputType format, MockServerClient mock) throws IOException {
        ...
        ExecOut out = exec(format, mock, "-v", "datasets", "create", tempFile(new String(loadResource("datasets/dataset_data", "csv"), StandardCharsets.UTF_8), "data", ".csv"), "-w", "249664655368293", "-n", "dataset3", "-d", "Dataset 3 description.");
