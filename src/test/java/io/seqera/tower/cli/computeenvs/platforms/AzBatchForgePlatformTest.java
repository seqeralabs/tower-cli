...
class AzBatchForgePlatformTest extends BaseCmdTest {
    ...
    void testCreate(MockServerClient mock) {
        ...
        ExecOut out = exec(mock, "compute-envs", "create", "azure-batch", "-n", "azure", "-l", "europe", "-w", "az://nextflow-ci/jordeu");
    ...
    void testCreateWithAdvancedOptions(MockServerClient mock) {
        ...
        ExecOut out = exec(mock, "compute-envs", "create", "azure-batch", "-n", "azure", "-l", "europe", "-w", "az://nextflow-ci/jordeu", "--token-duration=24");
