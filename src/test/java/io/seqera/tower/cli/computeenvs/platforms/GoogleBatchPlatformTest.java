...
class GoogleBatchPlatformTest extends BaseCmdTest {
    ...
    void testAddWithAdvancedOptions(MockServerClient mock) throws IOException {
                ...
                response().withStatusCode(200)
                    .withBody("""
                        ...
                        "credentials":[{
                            ...
                            "dateCreated":"2021-09-08T12:57:04Z","lastUpdated":"2021-09-08T12:57:04Z"
                        }]
                    }""")
                        ...
                        .withBody(JsonBody.json("""
                                {
                                  "computeEnv": {
                                    ...
                                    "config": {
                                      ...
                                      "serviceAccount": "service.account@google.com"
                                    },
        ...
        ExecOut out = exec(mock, "compute-envs", "add", "google-batch", "-n", "google", "--work-dir", "gs://workdir", "-l", "europe", "--fusion-v2", "--wave", "--use-private-address", "--service-account-email", "service.account@google.com");
