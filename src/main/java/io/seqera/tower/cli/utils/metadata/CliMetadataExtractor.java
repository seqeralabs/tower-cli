 ...
 *
 * Usage:
 *   java -cp <classpath> io.seqera.tower.cli.utils.metadata.CliMetadataExtractor [output-file]
 *
 * Outputs:
 *   - cli-metadata.json: Processed metadata with hierarchy and flat command map
 *
 * If no output file is specified, writes cli-metadata.json to stdout.
 */
