...
public class StudioStopSubmitted extends Response {
    ...
    public StudioStopSubmitted(String sessionId, String userSuppliedStudioIdentifier, Long workspaceId, String workspaceRef, Boolean jobSubmitted) {
