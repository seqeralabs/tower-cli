...
public class SlurmPlatform extends AbstractPlatform<SlurmComputeConfig> {
    ...
    public static class AdvancedOptions {
        @Option(names = {"--max-queue-size"}, description = "Maximum number of jobs Nextflow can submit simultaneously to the Slurm queue. Controls job submission rate. Default: 100.")
