...
public class MoabPlatform extends AbstractPlatform<MoabComputeConfig> {
    ...
    public static class AdvancedOptions {
        @Option(names = {"--max-queue-size"}, description = "Maximum number of jobs Nextflow can submit simultaneously to the Moab queue. Controls job submission rate. Default: 100.")
