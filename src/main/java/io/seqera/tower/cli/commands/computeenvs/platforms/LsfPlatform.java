...
public class LsfPlatform extends AbstractPlatform<LsfComputeConfig> {
    ...
    public static class AdvancedOptions {
        @Option(names = {"--max-queue-size"}, description = "Maximum number of jobs Nextflow can submit simultaneously to the LSF queue. Controls job submission rate. Default: 100.")
