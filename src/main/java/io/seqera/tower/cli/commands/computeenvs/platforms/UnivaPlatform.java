...
public class UnivaPlatform extends AbstractPlatform<UnivaComputeConfig> {
    ...
    public static class AdvancedOptions {
        @Option(names = {"--max-queue-size"}, description = "Maximum number of jobs Nextflow can submit simultaneously to the Univa Grid Engine queue. Controls job submission rate. Default: 100.")
