...
def add_lsf(
    ...
    max_queue_size: Annotated[
        ...
        typer.Option(
            "--max-queue-size",
            help="This option limits the number of jobs Nextflow can submit to the LSF queue at the same time [default: 100]",
        ),
    ] = None,
    ...
    unit_for_limits: Annotated[
        ...
        typer.Option(
            "--unit-for-limits",
            help="This option defines the unit used by your LSF cluster for memory limits. It should match the attribute LSF_UNIT_FOR_LIMITS setting in your lsf.conf file",
        ),
    ] = None,
    per_job_mem_limit: Annotated[
        ...
        typer.Option(
            "--per-job-mem-limit",
            help="Whether the memory limit is interpreted as per-job or per-process. It should match the attribute LSB_JOB_MEMLIMIT in your lsf.conf file",
        ),
    ] = None,
    per_task_reserve: Annotated[
        ...
        typer.Option(
            "--per-task-reserve",
            help="Whether the memory reservation is made on job tasks instead of per-host. It should match the attribute RESOURCE_RESERVE_PER_TASK in your lsf.conf file",
        ),
    ] = None,
